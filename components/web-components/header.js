        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .language-toggle:hover {
                    ...
                    border-color: var(--button-hover-border, #cbd5e1);
                    color: var(--button-hover-text, #1e293b);
                }
                ...
                .language-option:hover {
                    background: var(--option-hover-bg, #f1f5f9);
                }
                ...
                @media (prefers-color-scheme: dark) {
                    .header {
                        background: var(--header-bg-dark, #1f2937);
                    ...
                    .language-dropdown {
                        background: var(--dropdown-bg-dark, #1f2937);
                        border-color: var(--border-color-dark, #374151);
                    }

                    .language-option:hover {
                        background: var(--option-hover-bg-dark, #374151);
                    }
